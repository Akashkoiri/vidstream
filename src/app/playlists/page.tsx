  ...
  return (
    <div className="mx-auto w-full max-w-[1400px] space-y-10 px-4 pt-24 pb-12 sm:px-6 sm:pt-28 lg:px-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">
            Curate your favorite movies and shows
          </p>
        </div>
      ...
      <div className="space-y-12">
        {playlistsWithMovies.map((pl, index) => (
          <div key={pl.id}>
            <div className="group/playlist flex flex-col gap-4">
              {/* Playlist header */}
                  ...
                  <CarouselScroller>
                    {pl.itemsWithMovie.map(({ item, movie }) => {
                      ...
                      return (
                        <div
                          key={item.id}
                          className="relative flex-none w-[160px] sm:w-[200px] md:w-[240px] snap-start shrink-0 transition-transform duration-300 hover:z-10 hover:-translate-y-2"
                        >
            ...
            {/* Show an ad after every 2 playlists */}
            {(index + 1) % 2 === 0 &&
              index !== playlistsWithMovies.length - 1 && (
                <div className="mt-12">
                  <ResponsiveBanner />
                </div>
              )}
      ...
      {playlistsWithMovies.length > 0 && <ResponsiveBanner />}
    </div>
  );
}
