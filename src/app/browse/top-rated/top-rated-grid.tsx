// app/browse/top-rated/top-rated-grid.tsx
"use client";

import { useQuery } from "@tanstack/react-query";
import { getTopRatedMovies, getImageUrl } from "@/lib/tmdb";
...
export function TopRatedGrid({ page }: { page: number }) {
  ...
  if (error || !data) {
    return <p>Failed to load top rated movies.</p>;
  }
