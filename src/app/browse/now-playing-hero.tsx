...
export function NowPlayingHero({ movies }: Props) {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-slate-950">
      ...
      {/* DOTS */}
      <div className="absolute inset-x-0 bottom-12 md:bottom-20 z-20 flex justify-center">
...
function HeroSlide({ movie, isActive, index }: SlideProps) {
  ...
  return (
    <article className="relative flex min-w-full items-end overflow-hidden h-[100svh] pb-20 sm:pb-24 md:pb-28">
      {/* BACKDROP IMAGE */}
      {backdrop && (
